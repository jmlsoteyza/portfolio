...
export const TabsData1 = [
  {
    id: 1,
    title: "KicksAE",
    desc: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unkno to make a type specimen book.",
  ...
  },
  {
    ...
    desc: "I created a website that incorporates the Pomodoro app, the Todo app, a music player, and the YouTube Search API. It is designed for people who want to study while also relaxing. The website is connected with Youtube Api v3, a popular API for youtube embeding and manipulating YouTube data.",
